...
<?php
    ...
    $querry1 = "SELECT * FROM foods WHERE meal_id = 1";
    // this is for meal id 1
    $app1 = new App;
    $meals_1 = $app1->selectAll($querry1);

    $querry2 = "SELECT * FROM foods WHERE meal_id = 2";
    // this is for meal id 2
    $app2 = new App;
    $meals_2 = $app2->selectAll($querry2);

    $querry3 = "SELECT * FROM foods WHERE meal_id = 3";
    // this is for meal id 3
    $app3 = new App;
    $meals_3 = $app3->selectAll($querry3);

    $querry4 = "SELECT * FROM reviews";
    // this is for meal id 3
    $app4 = new App;
    $reviews = $app4->selectAll($querry4);
                    ...
                    <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <form method="POST" action= "booking-table.php">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea name="sp_request" class="form-control" placeholder="Special Request" id="message" style="height: 100px"></textarea>
