<?php
    $obj2 = new App;
    $obj2->startingSession();
    define("APPURL","http://localhost/RestaurantProject");
    define("APPIMAGES","http://localhost/RestaurantProject/admin-panel/foods-admins/foods-images");
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="<?php echo APPURL; ?>/booking.php" class="nav-item nav-link"><i class="fa-sharp fa-solid fa-cart-shopping"></i>Book Table</a>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                             <?php echo $_SESSION['username']; ?>
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/users-bookings.php?id=<?php echo $_SESSION['id']; ?>">Bookings</a></li>
                                <li><a class="dropdown-item" href="<?php echo APPURL; ?>/users/users-orders.php?id=<?php echo $_SESSION['id']; ?>">Orders</a></li>
