<?php
    $obj3 = new App;
    if(!isset($_SESSION)){
      $obj3->startingSession();
    }
    //$obj3->startingSession();
    if (!defined('ADMINURL')) define('ADMINURL', 'http://localhost/RestaurantProject/admin-panel');
    if (!defined('APPIMAGES1')) define('APPIMAGES1', 'http://localhost/RestaurantProject/admin-panel/foods-admins/foods-images');
    //define("ADMINURL","http://localhost/RestaurantProject/admin-panel");
        ...
        <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?php echo ADMINURL; ?>/admins/admins_logout.php">Logout</a>
